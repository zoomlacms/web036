<%@ page language="C#" autoeventwireup="true" inherits="CN_nite_Position_PositionManage, App_Web_wx3aiqyo" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>职位管理</title>
      ...
      <asp:Repeater ID="gvCard" runat="server">
        <ItemTemplate>
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td height="22" align="center"><%#Eval("Jid").ToString()%></td>
