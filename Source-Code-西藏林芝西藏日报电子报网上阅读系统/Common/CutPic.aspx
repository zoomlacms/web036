<%@ page language="C#" autoeventwireup="true" inherits="manage_Common_CutPic, App_Web_gz00rb2v" enableviewstatemac="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
function SaveUrl() {
    parent.setCutUrl('<%=Request.QueryString["dimg"] %>',jQuery("#bgDiv").find("img").attr("src"),'<%=ZoomLa.Components.SiteConfig.SiteOption.UploadDir %>');
    parent.closdlg();
}
</script> 
</body>
