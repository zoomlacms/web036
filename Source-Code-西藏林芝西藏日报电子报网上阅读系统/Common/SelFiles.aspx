<%@ page language="C#" autoeventwireup="true" inherits="Common_SelFiles, App_Web_fqccbaaa" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="form-group">
            <asp:TextBox ID="ImgName_T" runat="server" CssClass="form-control" placeholder="图片名"></asp:TextBox>
