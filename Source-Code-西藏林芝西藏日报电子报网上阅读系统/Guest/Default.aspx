<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="BBS_leaveword, App_Web_02x05dbx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <div id="userDiv" runat="server">
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td>
              <asp:TextBox ID="VCode" MaxLength="6" runat="server" CssClass="form-control" Width="100" Style="display: inline-table;" autocomplete="off" />
