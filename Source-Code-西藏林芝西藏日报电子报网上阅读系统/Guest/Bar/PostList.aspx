<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_PostList, App_Web_huwqtzwi" masterpagefile="~/Guest/Guest.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div class="tie_list">
                ...
                <div class="subdiv">
                    ...
                    <div id="view_div_<%#Eval("ID") %>" class="view_div" style="display: none;">
                        <div class="font12">
                            <span><span class="glyphicon glyphicon-upload"></span><a href="javascript:;" onclick="Collapse();">收起</a><span class="sperspan">|</span></span>
                            <span><span class="glyphicon glyphicon-arrow-left"></span><a href="javascript:;" onclick="RoteImg('view_img_<%#Eval("ID") %>',1);">左转</a><span class="sperspan">|</span></span>
                            <span><span class="glyphicon glyphicon-arrow-right"></span><a href="javascript:;" onclick="RoteImg('view_img_<%#Eval("ID") %>',2);">右转</a><span class="sperspan">|</span></span>
                            <span><span class="glyphicon glyphicon-th-large"></span><a href="javascript:;" onclick="ViewImg(<%#Eval("ID") %>);">查看大图</a></span>
                        </div>
                        <div><span><img id="view_img_<%#Eval("ID") %>" data-angle="0" src="#" onclick="Collapse();" /></span></div>
                    </div>
                </div>
                <div class="font12 tie_rel_count">
                    <div><span class="glyphicon glyphicon-user"></span><a href="<%#CreateUrl(1,"")+"?uid="+Eval("CUser") %>"><%#Eval("CUName") %></a></div>
                    <div><%#GetRUser() %></div>
                </div>
                <div class="clearboth"></div>
            </div>
