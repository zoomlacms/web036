<%@ page language="C#" autoeventwireup="true" inherits="test_getOrderInfo, App_Web_acg51o2n" masterpagefile="~/Cart/order.master" enableviewstatemac="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="head_div">
        ...
        <img class="head_r_img" src="/App_Themes/ICMS/images/step2.png" />
    </div>
        ...
        <div class="bordered">
            ...
            <div class="indent">
                <ul class="methodul">
                    ...
                    <li runat="server" id="siconli" title="用户银币支付"><i class="fa fa-rouble">银币支付</i><input type="radio" class="hidden" name="method_rad" value="3" /></li>
                    <li runat="server" id="pointli" title="用户积分支付" visible="false"><i class="fa fa-money">积分支付</i><input type="radio" class="hidden" name="method_rad" value="4" /></li>
                </ul>
        ...
        <div class="bordered">
            ...
            <div class="indent">
                ...
                <div id="invoice_div">
                    ...
                    <div>
                        <asp:TextBox runat="server" ID="InvoTitle_T" CssClass="form-control margin_t5" MaxLength="50" placeholder="个人或公司名称"></asp:TextBox><span class="r_red_x">*发票抬头</span>
                        <asp:TextBox runat="server" ID="Invoice_T" TextMode="MultiLine" class="form-control invoice_t" MaxLength="200" placeholder="请输入发票明细" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <tr>
                    <td colspan="6">
                        <div class="text-right">
                            ...
                            <div><span>优惠：</span><i class="fa fa-rmb " id="arrive_money_sp">0.00</i></div>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <script type="text/javascript">
        ...
        function ArriveCheck() {
            ...
            $.post("order.ashx", model, function (data) {
