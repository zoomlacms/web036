<%@ page language="C#" autoeventwireup="true" inherits="test_Cart_address, App_Web_o3v1qsmd" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
...
<table class="table table-bordered">
        <tr><td style="width:120px;" class="text-right">所在地区：</td><td>
                    <select id="province_dp" name="province_dp"></select>
                    <select id="city_dp"></select>
                    <select id="county_dp"></select>
