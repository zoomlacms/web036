<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="user_iServer_AddQuestion, App_Web_ul2jhuh0" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content ContentPlaceHolderID="head" runat="Server">
    <title>提交问题</title>
    <script type="text/javascript" charset="utf-8" src="/Plugins/Ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/Plugins/Ueditor/ueditor.all.min.js"></script>
    <script type="text/javascript" src="/Plugins/Ckeditor/ckeditor.js"></script>
    <script type="text/javascript" src="http://win01:86/JS/DatePicker/WdatePicker.js"></script>
</asp:Content>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    <td>希望问题解决的时间</td>
                                                    <td id="dropdownlist3">  
                                                        <select class="form-control" onchange="AddDate()">
                                                        ...
                                                        <input type="text"  id="mydate_t" class="form-control" onblur="WdatePicker({})" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd',minDate:'<%=DateTime.Now.AddDays(1).ToString("yyyy/MM/dd")%>'})" />                                       
                                                    </td>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#mydate_t").focus();
            setTimeout(function () { $dp.hide(); }, 200);//WdateDiv
        })
        function AddDate() {
