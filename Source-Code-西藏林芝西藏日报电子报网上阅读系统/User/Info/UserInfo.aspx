<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserInfo, App_Web_0a3c0ray" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_seta" style="margin-top: 10px;" id="manageinfo" runat="server">
            ...
            <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                ...
                <tr class="tdbg" style="width: 100%">
                    ...
                    <td style="width: 250px; "><asp:Label ID="gradeTxt" runat="server" ></asp:Label></td>
                </tr>
                <tr class="tdbg" style="width: 100%">
