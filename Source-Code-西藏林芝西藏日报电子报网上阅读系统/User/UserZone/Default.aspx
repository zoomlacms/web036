<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserZone_Default, App_Web_yshcyfhx" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div style="margin: auto; width: 100%">
        <asp:MultiView ID="MultiView1" runat="server">
            <asp:View ID="View1" runat="server">
                ...
                <div class="us_topinfo" style="margin-top: 10px; width: 98%"><a href="/user/userzone/StyleSet.aspx">设定空间模板</a> | <a href="/ShowList.aspx?id=<%=id %>" target="_blank">个人空间首页</a></div>
