<%@ page language="C#" autoeventwireup="true" masterpagefile="~/User/Default.master" inherits="User_UserTalk_TalkLog, App_Web_ermoxxwo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div>
        <asp:TextBox ID="ReUser_T" CssClass="form-control" runat="server" placeholder="接收人"></asp:TextBox>
        <asp:TextBox ID="SDate_T" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm'});" CssClass="form-control" runat="server" placeholder="开始时间"></asp:TextBox>
        <asp:TextBox ID="EDate_T" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm'});" CssClass="form-control" runat="server" placeholder="结束时间"></asp:TextBox>
