<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Default, App_Web_djnyjwbl" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>会员中心</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding0 user_div">
        ...
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
            <div style="background:#6633FF" class="user_base">
                <a href="javascript:;" onclick="openmenu('menu5','/User/UserZone/Default.aspx')">社区互动</a>
            </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
            <div style="background:#27a9e3" class="user_base">
