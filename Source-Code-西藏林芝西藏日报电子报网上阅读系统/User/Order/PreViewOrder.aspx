<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_PreViewOrder, App_Web_3hgz0ro3" clientidmode="Static" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div runat="server" id="DV_show">
        <div class="btn-group">
            ...
            <a class="btn btn-primary" href="/Cart/AddressList.aspx">收货地址</a>
        </div>
            ...
            <asp:Panel ID="Orderlist" runat="server" Visible="false">
                <table class="table table-striped table-bordered">
                    <tr>
                        ...
                        <td style=" text-align: center;" class="td_lg">订单金额</td>
                    ...
                    <ZL:ExRepeater runat="server" ID="Order_RPT" OnItemDataBound="Order_RPT_ItemDataBound" OnItemCommand="Order_RPT_ItemCommand" PagePre="<tr><td colspan='13' style='text-align:center;'>" PageEnd="</td></tr>" PageSize="10">
                        <ItemTemplate>
                            <tr>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <a href="OrderProList.aspx?OrderNo=<%#Eval("Cartid")%>&SType=1">查看</a>
