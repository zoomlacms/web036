<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_OrderList, App_Web_lvst0iro" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ZL:ExRepeater runat="server" ID="Store_RPT" PageSize="10" PagePre="<tr id='page_tr'><td><input type='checkbox' id='chkAll'/></td><td colspan='10' id='page_td'>" PageEnd="</td></tr>">
                <ItemTemplate>
                  <tr ondblclick="location='Orderlistinfo.aspx?id=<%#Eval("ID") %>';">
                      ...
                      <td><a onclick="opentitle('/User/info/UserBase.aspx?id=<%#Eval("userId") %>','查看会员')" href="javascript:;" title="查看会员"><%#GetUsers(Eval("userId", "{0}"))%></a></td>
                      <td><%#Eval("AddTime") %></td>
