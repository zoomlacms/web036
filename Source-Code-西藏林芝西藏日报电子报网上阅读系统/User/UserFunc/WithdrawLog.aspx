<%@ page language="C#" autoeventwireup="true" inherits="User_UserFunc_WithdrawLog, App_Web_omnge4r1" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  
      ...
      <Columns>
          <asp:TemplateField HeaderText="申请日期"><ItemTemplate><%#Eval("CDate","{0:yyyy年MM月dd日 HH:mm}") %></ItemTemplate><ItemStyle  Width="200"/></asp:TemplateField>
          <asp:TemplateField HeaderText="提现金额"><ItemTemplate><%#Eval("Str1","{0:f2}") %></ItemTemplate></asp:TemplateField>
          ...
          <asp:BoundField HeaderText="拒绝理由" DataField="Str4" />
          <asp:BoundField HeaderText="备注" DataField="Describe" />
      </Columns>
      </ZL:ExGridView>
</asp:Content>
