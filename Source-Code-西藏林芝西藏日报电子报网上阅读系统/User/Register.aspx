<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_f1k1krpz" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html lang="zh-CN">
<head>
...
<link href="/App_Themes/UserThem/Responsive.css" rel="stylesheet" />
<style type="text/css">.form-control{width:90%;display:inline;}</style>
...
<script type="text/javascript">
     ...
     function vaildDate() {
         $.ajax({
             type: "POST",
             url: "Register.aspx",
             data: "action=birthdate&value=" + $("#TxtBirthday").val(),
             success: ReceiveServerDataID,
             Error: function (msg) {
                 alert("地址获取失败");
             }
         });
     ...
     //-------------------------
     function gotouser() {
         window.setTimeout(function () { location = document.getElementById("hfReturnUrl").value }, 5000);
     }
     var ms = 5;
...
<!--
                            ...
                            <ul>
                                <li>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="TxtUserName" CssClass="form-control required" runat="server" onblur="CheckUser();" />
                                        </div>
                        ...
                        <asp:Literal ID="Literal2" runat="server"></asp:Literal>～<asp:Literal ID="Literal1" runat="server"></asp:Literal>个字符之间</span>
                                ...
                                <li>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="TxtPassword" TextMode="Password" runat="server" CssClass="form-control required" onfocus=" focusinput();" onkeyup="f_checkrank();" />
                                        </div>
                                        <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0 ">
                                            <div id="valPass">
                                ...
                                <li>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="TxtPwdConfirm" TextMode="Password" runat="server" CssClass="form-control required" />
                                        </div>
                                        <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0  text-left">
                                            ...
                                            <asp:CompareValidator ID="req2" runat="server" ControlToValidate="TxtPwdConfirm" ControlToCompare="TxtPassword"
                                                Operator="Equal" SetFocusOnError="false" ValidationGroup="userVaid" ErrorMessage="两次密码输入不一致" Display="Dynamic" ForeColor="Red"></asp:CompareValidator>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </li>
                                <li id="regVcodeRegister" runat="server" visible="false">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="VCode" MaxLength="6" runat="server" CssClass="form-control" autocomplete="off" />
                                            <input type="hidden" id="VCode_hid" name="VCode_hid" />
                                        </div>
                                        <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0  text-left">
                                            <img id="VCode_img" title="点击刷新验证码" class="code"  style="cursor: pointer; border: 0; vertical-align: middle;"/>
                                            <asp:RequiredFieldValidator ID="rv2" runat="server" ControlToValidate="VCode" Display="Dynamic" ForeColor="Red" ErrorMessage="验证码不能为空!" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </li>
                                        ...
                                        <table style="border-collapse: collapse" cellspacing="1" cellpadding="2" width="100%"
                                            ...
                                            <tr class="tdbgleft">
                                                <td>
                                                    ...
                                                    <asp:Button ID="BtnSubmit" runat="server" Text="注册" CssClass="btn btn-primary" ValidationGroup="userVaid" OnClick="BtnSubmit_Click" />
                                                    ...
                                                    <td class="tdbgleft" colspan="2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 text-left">
                                                                ...
                                                                <select name="selcoutry" id="selcoutry"></select>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <style type="text/css">.d_ok {color:green;}.d_err {color:red;}</style>
</body>
</html>
