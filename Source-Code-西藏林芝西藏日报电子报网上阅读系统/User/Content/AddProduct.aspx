<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" validaterequest="false" inherits="Zoomla.Website.User.Shop.AddProduct, App_Web_nrvdz5qq" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
     <ol class="breadcrumb" style="margin-bottom:0px;">
        ...
        <li><a href="Myproduct.aspx?NodeID=<%=NodeID %>">商品管理</a></li>
