<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Domain_ViewHave, App_Web_2g44ugrv" masterpagefile="~/Manage/Site/OptionMaster.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<RowStyle Height="24px" HorizontalAlign="Center" />
	<Columns>
		...
		<asp:TemplateField HeaderText="操作" Visible="false">
			 <ItemTemplate>
				<a href="/PayOnline/OrderPay.aspx?OrderCode=<%#Eval("OrderNo") %>">完成支付</a>
				<a href="/Shop.aspx?ID=<%#Eval("ProID") %>" target="_viewDetail">查看详情</a>
			</ItemTemplate>
		</asp:TemplateField>
	</Columns>
