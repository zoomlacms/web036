<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_DomName, App_Web_2g44ugrv" masterpagefile="~/Manage/Site/SiteMaster2.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="site_main">
    <div id="leftDiv">
      ...
      <%--  <div class="twoOption"><a href="javascript:;" id="tabBtn2" onclick="ShowTabs(this,'tab2')"><span class="twoWord">注册模板</span></a></div>--%>
        ...
        <div class="twoOption"><a href="javascript:;" id="tabBtn7" onclick="ShowTabs(this,'tab1');openFrame('ViewHave.aspx')"><span class="twoWord">已购买服务</span></a></div>
        <div class="twoOption"><a href="javascript:;" id="tabBtn5" onclick="ShowTabs(this,'tab5')"><span class="twoWord">用户充值</span></a></div>
    </div>
    <div id="rightDiv">
    <div id="tab1">
