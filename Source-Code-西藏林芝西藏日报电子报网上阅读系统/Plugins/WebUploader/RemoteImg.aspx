<%@ page language="C#" autoeventwireup="true" inherits="Plugins_WebUploader_RemoteImg, App_Web_o3ndigjg" masterpagefile="~/Plat/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="Head"><title>获取远程图片</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="panel-body">
        <div class="alert alert-info">请输入远程图片Http路径,以回车分隔</div>
    ...
    <div class="panel-footer">
        <asp:Button runat="server" ID="GetPic_Btn" Text="确定" OnClick="GetPic_Btn_Click" CssClass="btn btn-primary" />
    </div>
