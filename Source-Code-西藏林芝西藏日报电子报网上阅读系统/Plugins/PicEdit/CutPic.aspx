<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="CutPic.aspx.cs" Inherits="test_CutPic" %><!DOCTYPE html>
<html>
<head>
...
.cutbox { background: none;height:800px;}
        ...
        <form id="form1" runat="server">
            ...
            <div id="imgFunc">
               ...
               <%--         <li><a href="#imgSmall" role="tab" data-toggle="tab"><i class="fa fa-table"></i>缩放</a></li>--%>
                   ...
                   <%-- <li><a href="#imgRoll" role="tab" data-toggle="tab"><i class="fa fa-undo"></i>旋转</a></li>
            ...
            <div id="imgBox">
                <div class="colo-lg-3 col-md-3 col-sm-4 col-xs-5 padding5" id="imgLeftFunc">
                    <div class="tab-content">
                            ...
                            <div class="imgTextItem">
                                <ul class="list-unstyled" role="menu">
                                    ...
                                    <%--    <asp:RadioButton runat="server" Text="约束比例" />--%></span>
                                        <span class="pull-right"><input type="button" class="btn btn-default" onclick="ApplyCut();" value="应用裁剪"  /></span>
                                    </li>
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                    <li><h4>预览</h4></li>
                        ...
                        <div class="tab-pane" id="imgSmall">
                            <div class="imgTextItem">
                                <ul class="list-unstyled" role="menu">
                                    ...
                                    <li><span>宽</span><input type="text" class="form-control">px</li>
                                    <div class="clearfix"></div>
                                    <li><span>高</span><input type="text" class="form-control">px</li>
                                    <li><span class="pull-left">
                                        <asp:RadioButton runat="server" Text="约束比例" /></span></li>
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                </ul>
                            </div>
                                    ...
                                    <asp:Repeater runat="server" ID="RPT">
                                        <ItemTemplate>
                                            <li class="col-lg-4 col-md-4 col-sm-4 col-xs-4 padding5" style="height:100px;">
                                               <label title="<%#Eval("Name") %>"><img src="<%#Eval("Path") %>" class="center-block img-responsive" alt="水印方案">
                      ...
                      <%--  <div class="tab-pane" id="imgRoll">
                            旋转

                        </div>
                        <div class="tab-pane" id="imgQua">
                            品质
                        </div>
                        <div class="tab-pane" id="imgQua">
                            左转180°
                ...
                <div class="colo-lg-9 col-md-9 col-sm-12 col-xs-7 pull-right padding5">
                    <div id="imgRightFunc" style="height:750px;width:786px;overflow:scroll;border:1px solid #fff;">
            ...
            $(function () {
                selectObj = $('#photo').imgAreaSelect({
                    ...
                    onSelectEnd: function (img, selection) {
                        ...
                        $("#preview_img").css({
							width:phoWidth*scaleX,
							height:phoHeight*scaleY,
