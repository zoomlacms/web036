<%@ page language="C#" autoeventwireup="true" enablesessionstate="True" inherits="Plat_Task_Default, App_Web_cvnnpgqy" masterpagefile="~/Plat/Main.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 paddin5">
<div runat="server" id="pcmsgdiv">
  ...
  <div class="msg_opdiv"><a href="javascript:;" onclick="ShowDiv('topicDiv');"><span class="spanico">#</span><span>话题</span></a>
	...
	<iframe id="GroupAT_ifr" class="msgex"></iframe>
      ...
      <a href="javascript:;" onclick="ShowFileUP();"><span class="glyphicon glyphicon-paperclip spanico"></span><span>附件</span></a> <span class="msg_opdiv_span">
  ...
  <asp:Repeater runat="server" ID="MsgRepeater" OnItemDataBound="MsgRepeater_ItemDataBound" EnableViewState="false">
	<ItemTemplate>
	  <div class="msgitem" id="msgitem-<%#Eval("ID") %>">
		<div class="msg_left_div" style="position:absolute;">
            <div class="uinfodiv">
              <div class="loadok hidden_div">
                  <div class="padding10">
                      <div class="pull-left">
                          <img src="/Images/ajax-loader.gif" class="imgface_max" />
                      </div>
		    ...
		    <div class="pull-left"><img class="imgface_mid uinfo" src="<%#Eval("UserFace") %>" title="<%#Eval("CreateUName") %>" data-uid="<%#Eval("CreateUser") %>" /></div>
		</div>
...
//var diag2=new ZL_Dialog({title:"<strong>撰写文章(最多不能超过10000个字符)</strong>",content:"article_div",width:"width1100"});
