<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Pay.AddPayPlat, App_Web_jcith40z" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ContentTemplate>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td> 
                        <asp:RadioButtonList ID="DDLPayPlat" runat="server" Height="83px" RepeatColumns="6">
                            </asp:RadioButtonList>                        
                    </td>
                </tr>
                <tr >
