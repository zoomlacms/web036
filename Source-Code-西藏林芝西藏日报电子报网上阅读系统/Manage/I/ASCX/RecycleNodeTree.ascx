<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_RecycleNodeTree, App_Web_slvd0jyy" clientidmode="Static" %>
   
<div class="menu_tit"><span class="glyphicon glyphicon-globe"></span>内容管理</div>
 <div id="nodeNav" style="padding:0 0 0 0;">
        <div class="input-group">
            <input type="text" ID="keyWord" class="form-control ascx_key" onkeydown="return ASCX.OnEnterSearch('<%:CustomerPageAction.customPath2+"Content/ContentRecycle.aspx?keyWord=" %>',this);" placeholder="搜索内容" />
            <span class="input-group-btn">
                <button class="btn btn-default" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Content/ContentRecycle.aspx?keyWord=" %>','keyWord');"><span class="glyphicon glyphicon-search"></span></button>
            </span>
        </div>
        <div>
            <div class="tvNavDiv">
