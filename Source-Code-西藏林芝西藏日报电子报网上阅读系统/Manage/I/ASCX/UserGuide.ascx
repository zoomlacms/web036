<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_UserGuide, App_Web_13s41bkk" %>
...
<div class="left_ul">
    ...
    <li class="guideli"><a onclick="ShowMain('','User/DepositManage.aspx')">用户提现</a></li>
    <li class="guideli"><a onclick="ShowMain('','Shop/PVManager.aspx')">订单提成</a></li>
    <li class="guideli"><a onclick="ShowMain('','User/UnitMain.aspx')">会员提成</a></li>
