<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_AddNode, App_Web_mrqqbq1i" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
			...
			<tbody>
				<tr>
					...
					<td onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
						...
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('TxtIndexTemplate')+'&FilesDir=')" />
				...
				<tr>
					...
					<td>
						...
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('TxtTemplate')+'&FilesDir=')" />
				...
				<tr>
					...
					<td>
						...
						<input type="button" value="手工绑定 " class="btn btn-primary" style="width: 100px;" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('LastinfoTemplate')+'&FilesDir=')" />
				...
				<tr>
					...
					<td>
						...
						<%# Eval("GroupName")%>
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('HotinfoTemplate')+'&FilesDir=')" />
				...
				<tr>
					...
					<td>
						...
						<%# Eval("GroupName")%>
						<input type="button" value="手工绑定" class="btn btn-primary" style="width: 100px;" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('ProposeTemplate')+'&FilesDir=')" />
								...
								<ItemTemplate>
									<tr class="tdbg">
										...
										<td>
											...
											<input type="button" value="手工绑定" class="btn btn-primary" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('TxtModelTemplate_<%# Eval("ModelID") %>    ')+'&FilesDir=')" />
