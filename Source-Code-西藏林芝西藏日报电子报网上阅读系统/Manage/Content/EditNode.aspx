<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditNode, App_Web_sxzm1jra" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('TxtIndexTemplate')+'&FilesDir=')" class="btn btn-primary" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('TxtTemplate')+'&FilesDir=')" class="btn btn-primary" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('LastinfoTemplate')+'&FilesDir=')" class="btn btn-primary" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('HotinfoTemplate')+'&FilesDir=')" class="btn btn-primary" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="手工绑定" onclick="ShowTList('../Template/TemplateList.aspx?OpenerText='+escape('ProposeTemplate')+'&FilesDir=')" class="btn btn-primary" />
