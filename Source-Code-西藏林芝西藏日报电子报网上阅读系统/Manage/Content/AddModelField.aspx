<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddModelField, App_Web_sxzm1jra" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tbody id="DivTextType" runat="server">
	...
	<tr>
		...
		<td>
			<asp:TextBox ID="TextType_DefaultValue" CssClass="form-control" runat="server" Text="{nowuser}|匿名|本站作者" />
...
<tbody id="DivImages" style="display: none">
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox1" CssClass="form-control pull-left" Text="jpg,png,gif,bmp" Style="max-width: 200px;" runat="server" Columns="30"></asp:TextBox>
...
<tbody runat="server" id="DivNumType" style="display: none">
	...
	<tr class="tdbg" id="showdec" style="display: none" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			<asp:TextBox ID="txtdecimal" CssClass="form-control pull-left" Style="max-width: 80px;" runat="server" Text="2"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td>
