<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.login, App_Web_3udahfoi" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ul class="list-unstyled text-center center-block">
        ...
        <li id="CodeLi" runat="server" visible="false" style="margin-bottom:0;">
            <div class="form-group has-feedback" style="display:inline-block;width:400px;">
               <asp:TextBox ID="VCode" runat="server" class="form-control" TabIndex="3" autocomplete="off" onkeydown="return GetEnterCode('click','IbtnEnter');"/>
               <img id="VCode_img" runat="server" title="点击刷新验证码" class="code"  style="margin-left:5px;height:34px;"/>
