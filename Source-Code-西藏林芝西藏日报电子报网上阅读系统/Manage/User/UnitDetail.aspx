<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_UnitDetail, App_Web_sqzbmv5z" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="提成金额">
                <ItemTemplate><%#Eval("UnitAMount","{0:f2}") %></ItemTemplate>
            </asp:TemplateField>
    ...
    <div>总消费额<span class="rd_red_l" runat="server" id="TotalAmount_sp">0.00</span>,提成<span class="rd_red_l" runat="server" id="TotalUnit_sp">0.00</span></div>
    <style type="text/css">
