<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_UserManage, App_Web_sqzbmv5z" title="会员管理" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
	...
	<td><div class="input-group" style="float:left;">
		<asp:DropDownList ID="OrderType_DP" runat="server" CssClass="form-control" style="width:120px;border-right:none;" AutoPostBack="true" OnSelectedIndexChanged="OrderType_DP_SelectedIndexChanged">
		  ...
		  <asp:ListItem Value="descAddtime">注册时间倒序</asp:ListItem>
            <asp:ListItem Value="AuthTime">最近登陆</asp:ListItem>
