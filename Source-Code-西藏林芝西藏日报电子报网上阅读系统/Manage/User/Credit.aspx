<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserCart, App_Web_sqzbmv5z" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div id="UserPDiv" runat="server">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="detail" HeaderText="描述" />
    ...
    <table id="EditHis_Table" runat="server" visible="false" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="HidTime_T" runat="server" CssClass="form-control" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="text-right">信誉值：</td>
            <td><asp:TextBox ID="HidSocre_T" runat="server" CssClass="form-control"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="text-right">详细：</td>
            <td><asp:TextBox ID="HidDesc_T" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5"></asp:TextBox></td>
        </tr>
        <tr>
