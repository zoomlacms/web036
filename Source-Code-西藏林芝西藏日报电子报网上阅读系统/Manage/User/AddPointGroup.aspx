<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddPointGroup, App_Web_sssiipyt" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txt_imgUrl" runat="server" Style="max-width: 350px;" class="form-control" ></asp:TextBox>
                <iframe id="bigimgs" style="top: 2px;width:100%;height:25px;" src="/Common/fileupload.aspx?FieldName=imgUrl&ModelID=3&NodeID=1" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
            </td>             
        </tr>
        <tr>
