<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Scence, App_Web_3udahfoi" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
function SetConfig() {
	$.ajax({
		type: "Post",
		url: "Scence.aspx",
		data: { action: "Desk", value: GetConfig($("[name=Radio1]:Checked").val()) },
