<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ClassManage, App_Web_farmqmyf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr id="<%#Eval("GroupID") %>" ondblclick="ShowTabs(this.id)">
                    ...
                    <td height="22" align="center">
                        <a href="AutoPK.aspx?ClassID=<%#Eval("GroupID") %>">查看排课</a>
