<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Papers_System_Manage, App_Web_farmqmyf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <script>
        $().ready(function () {
            $("#EGV tr").dblclick(function () {
                ...
                if (id) {
                    location = "Add_Papers_System.aspx?menu=Edit&paper_id="+id;
                }
            });
        });
    </script>
