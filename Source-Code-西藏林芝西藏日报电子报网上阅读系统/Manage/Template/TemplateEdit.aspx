<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Manage_I_Content_TemplateEdit, App_Web_a4yhi3lz" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr class="title" style="font-weight: normal;">
            <td align="left" colspan="2">
               ...
               <div class="input-group" style="width: 300px; float:left">
                   ...
                   <asp:Label runat="server" ID="name_L" class="btn btn-default">
                       .html
                   </asp:Label>
                ...
                <div id="edit_div" visible="false" class="input-group" runat="server">                 	                               	
