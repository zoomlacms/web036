<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelCallTab, App_Web_a4yhi3lz" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered" >
        <tr>
            <td style="height: 410px;min-width: 377px;width:377px;vertical-align:top;text-align:left;">
                <div id="Tab1_header">
                    ...
                    <table runat="server" visible="false" enableviewstate="false">
                        <tr style="vertical-align:top;text-align:center;">
                            <td id="TabTitle0" runat="server" class="titlemouseover" onclick="ShowTabs(0)">自定标签</td>
                            <td id="TabTitle1" runat="server" class="tabtitle" onclick="ShowTabs(1)">数据字段</td>
                            <td id="TabTitle2" class="tabtitle" onclick="ShowTabs(2)">系统标签</td>
                            <td id="TabTitle3" class="tabtitle" onclick="ShowTabs(3)">扩展函数</td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
    ...
    <script type="text/javascript" src="/Plugins/CodeMirror/LabelCall.js"></script>
