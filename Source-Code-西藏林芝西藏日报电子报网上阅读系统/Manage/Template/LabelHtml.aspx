<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Template.LabelHtml, App_Web_c4jajjji" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table id="content" class="table table-striped table-bordered tab-content">
  <tbody class="tab-pane active" id="Info0">
    <tr>
      ...
      <td class="text-left" data-auto="maxwidth"><asp:TextBox ID="TxtLabelName" CssClass="form-control" runat="server" />
    ...
    <tr>
      ...
      <td class="text-left"><asp:TextBox ID="TxtLabelType" CssClass="form-control" runat="server"></asp:TextBox>
        <asp:DropDownList ID="DropLabelType" CssClass=" form-control label_class" runat="server" OnSelectedIndexChanged="SelectCate" AutoPostBack="true"> </asp:DropDownList></td>
    </tr>
    <tr>
      <td class="text-right"><strong>标签说明：&nbsp;</strong></td>
      <td class="text-left"><asp:TextBox ID="TxtLabelIntro" CssClass="form-control label_explain" runat="server" TextMode="MultiLine" Columns="50" Rows="3"></asp:TextBox></td>
    </tr>
  </tbody>
  <tbody class="tab-pane" id="Info1">
    ...
    <tr id="isbool" runat="server" visible="false">
      ...
      <td><asp:DropDownList ID="Modeltypeinfo" CssClass="form-control label_num" runat="server" AutoPostBack="True">
    ...
    <tr id="s2" runat="server" visible="false" onmouseover="this.className='tdbgmouseover'"
      ...
      <td style="width: 100%; text-align: right;" colspan="2"><table style="width: 100%">
          <tr>
            <td align="left"><asp:TextBox TextMode="MultiLine" runat="server" CssClass="form-control" ID="falsecontent" Style="max-width: 100%; height: 231px;"></asp:TextBox></td>
          </tr>
        </table></td>
    </tr>
  </tbody>
  <tr>
    <td colspan="2"><asp:HiddenField ID="HdnLabelID" runat="server" />
      ...
      <%--<input type="button" id="buttons" name="buttons" value="可视化预览" class="btn btn-primary" onclick="createEditor()" />--%></td>
  </tr>
</table>
