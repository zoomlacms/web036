<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_c4jajjji" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<li> <a href="labelSql.aspx">
  <asp:Label ID="LabelName" runat="server" />
  </a> <a href="../Config/CreateTable.aspx" id="a1" style="color: #1e860b;">添加新表</a><a href="labelSqlOne.aspx?LabelName=<%=Request["LabelName"] %>" style="color: #1e860b;">一步式标签编辑器</a> </li>
</ol>
...
<WizardSteps>
  <asp:WizardStep ID="WizardStep1" EnableTheming="true" runat="server" Title="step1">
	<table style="width: 100%;" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
	  ...
	  <tr class="tdbg">
		...
		<td align="left"><asp:TextBox ID="TxtLabelName" Width="200" class="form-control" runat="server" />
	  ...
	  <tr class="tdbg">
		...
		<td align="left"><asp:TextBox ID="TxtLabelType" Width="200" class="form-control pull-left" runat="server"></asp:TextBox>
	  ...
	  <tr class="tdbg">
		...
		<td align="left"><asp:TextBox ID="TxtLabelIntro" class="form-control" Width="200" runat="server" TextMode="MultiLine" Rows="3" Height="60px"></asp:TextBox></td>
	  </tr>
	  <tr class="tdbg">
		<td class="tdbgleft" align="right" style="width: 80px"><strong>数据架构：</strong></td>
		<td align="left"><asp:TextBox runat="server" Width="200" ID="schema_Text" Text="DBO"></asp:TextBox>
		  <span style="margin-left:5px;line-height:30px;color:green;"><small>*常规应用忽略此项（私有架构定义时用于区别DBO）</small> </span></td>
	  </tr>
	  <tr class="tdbg">
		<td colspan="2" height="28"><div style="width: 440px;margin-left:50px;">
  ...
  <asp:WizardStep ID="WizardStep2" runat="server" Title="step2">
	<table style="width: 100%;" cellpadding="2" cellspacing="1" class="table table-striped table-bordered">
	  ...
	  <tr>
		<td class="tdbg" colspan="2"><div style="width: 440px;margin-left:50px;">
  ...
  <asp:WizardStep ID="WizardStep3" runat="server" Title="step3">
	<table style="width: 100%;" cellpadding="2" cellspacing="1" class="table table-striped table-bordered">
	  ...
	  <tr>
		...
		<td class="tdbg"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="table table-striped table-bordered" style="text-align: center">
		  ...
		  <table border="0" cellpadding="0" cellspacing="1" class="table table-striped table-bordered" style="text-align: center">
			<tr class="tdbg" align="center" style="height: 25px;">
			  <td style="width: 80px;"><asp:TextBox ID="TxtParamName" CssClass="form-control required" runat="server" placeholder="参数名称" Width="120px" /></td>
			  <td style="width: 80px; height: 25px"><asp:TextBox ID="TxtParamValue" runat="server" placeholder="默认值" CssClass="form-control" Width="120px" /></td>
			  ...
			  <td style="width: 100px; height: 25px" align="left"><asp:TextBox ID="TxtParamDesc" runat="server" placeholder="参数说明" CssClass="form-control" Width="120px" /></td>
			  <td style="width: 80px; height: 25px"><asp:Button ID="BtnAddParam" runat="server" Text="添加" class="btn btn-primary" OnClientClick="return VoteCheck();" OnClick="BtnAddParam_Click" Style="cursor: pointer;" /></td>
	  ...
	  <tr>
		<td colspan="2"><div style="width:440px;margin-left:50px;">
  ...
  <asp:WizardStep ID="WizardStep4" runat="server" Title="step4">
	<table style="width: 100%;" cellpadding="2" cellspacing="1" class="table table-striped table-bordered">
	  ...
	  <tr>
		...
		<td bgcolor="#e8f5ff"><asp:CheckBox ID="boolmodel" runat="server" Text="判断模式" AutoPostBack="True" />
	  ...
	  <tr>
		<td class="padding-t0" colspan="2"><table style="width: 100%">
			<tr>
			  <td style="width: 382px;min-width:382px; vertical-align: top;" id="frmTitle"><table width="100%" border="0" cellpadding="0" cellspacing="0">
				  <tbody id="ss">
					<tr align="center">
						  ...
						  <div class="tab-content">
							<div class="tab-pane active" id="Tabs0">
							  <table width="100%" border="0" class="table table-bordered" cellpadding="0" cellspacing="0">
								<tbody>
								  <tr>
									<td class="text-center"><asp:DropDownList ID="DDLCate" runat="server" OnSelectedIndexChanged="ChangeCate" AutoPostBack="true"></asp:DropDownList></td>
								  </tr>
								  <tr align="center">
			  ...
			  <td align="left"><div id="Textarea" class="LabelTextarea">
	  ...
	  <tr>
		<td colspan="2"><div style="width: 440px; margin:auto;">
