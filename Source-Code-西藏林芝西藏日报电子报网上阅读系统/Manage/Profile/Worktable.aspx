<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa_WebSite_Manages_Worktable, App_Web_fkxvjfvl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html>
...
<div class="panel panel-default">
  ...
  <div class="panel-footer">
    ...
    <a href="<%:customPath2+"Common/SystemFinger.aspx" %>" class="margin-15" title="服务器信息总览"><span style="margin-right:2px;">服务器信息总览</span><i class="fa fa-forward"></i></a>
  </div>
</div>
</div>
