<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Orderlistinfo, App_Web_xeuo3oxo" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
            ...
            <asp:Repeater ID="procart" runat="server" OnItemDataBound="cartinfo_ItemDataBound">
                <ItemTemplate>
                    <tr
                        ...
                        <td style="height: 24px;"><img src="<%#ZoomLa.Common.function.GetImgUrl(Eval("Thumbnails"))%>" onerror="this.src='/Images/nopic.gif';" class="img_50" /></td>
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr>
            <td colspan="4" class="text-center">退款操作</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" class="text-center">
                <asp:Button ID="CheckReturn" Enabled="false" CssClass="btn btn-primary" Width="100px" runat="server" Text="确认退款" OnClientClick="return ShowDrawDiag(1);" />
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td width="20%" rowspan="3">
                ...
                <asp:Button ID="sendScore" class="btn btn-primary" runat="server" Text="赠送积分" Width="100px" OnClick="sendScore_Click" /><br />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                <td class="text-center" colspan="2">
                    ...
                    <asp:Button ID="UCheckReturn_B" CssClass="btn btn-primary" Text="确认" OnClick="UnCheckRetrun_Click" runat="server" />
