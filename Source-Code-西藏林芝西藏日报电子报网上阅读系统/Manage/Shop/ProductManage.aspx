<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.ProductManage, App_Web_sunz0hm4" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
   ...
   <div id="m_nodes" class="visible-xs visible-sm"></div>
    <script type="text/javascript">
      ...
      <div class="clearfix"></div>
        <div class=" btn-group" style="margin-bottom:10px;margin-top:10px;">
            ...
            <a class="btn btn-info" href="ProductManage.aspx?NodeID=<%=Request.QueryString["NodeID"] %>&quicksouch=18">用户商品</a>
            <a class="btn btn-info" href="ProductManage.aspx?NodeID=<%=Request.QueryString["NodeID"] %>&quicksouch=19">合作商品</a>
        </div>
        <div class="clearfix"></div>
    <div style="background: #ddd; padding: 4px 4px 4px 4px; margin-bottom: 6px; border-radius: 15px; line-height: 35px; padding-left: 15px;">
        ...
        <span class="pull-right visible-xs visible-sm">
            <input type="button" class="btn btn-success m_modal" onclick="opentitle('<%:Request.QueryString["NodeID"] %>    ','配置本节点');" value="节点选择" /></span>
