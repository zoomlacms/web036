<%@ page language="C#" autoeventwireup="true" inherits="Manage_Shop_OtherOrder_IDC_Ren, App_Web_gkcfb4bq" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="Num_T" CssClass="form-control td_s number required" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="text-right">支付方式:</td>
            <td>
                <label><input type="radio" checked="checked" name="paytype" value="1" />在线支付</label>
                <label><input type="radio" name="paytype" value="2" />余额支付</label>
                <label><input type="radio" name="paytype" value="3" />银币支付</label>
            </td>
        </tr>
