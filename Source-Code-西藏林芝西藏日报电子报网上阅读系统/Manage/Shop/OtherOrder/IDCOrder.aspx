<%@ page language="C#" autoeventwireup="true" inherits="Manage_Shop_OtherOrder_DomainOrder, App_Web_gkcfb4bq" validaterequest="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div id="TableList" runat="server">
      <table id="EGV" class="table table-bordered table-hover">
          <tr>
            ...
            <ZL:ExRepeater runat="server" ID="RPT" OnItemCommand="Orderlisttable_ItemCommand" PageSize="10" PagePre="<tr id='page_tr'><td><input type='checkbox' id='chkAll'/></td><td colspan='11' id='page_td'>" PageEnd="</td></tr>">
                <ItemTemplate>
                    <tr class="tdbg" id='<%#Eval("id") %>' ondblclick="getinfo(this.id)">
                        ...
                        <td>
                            <a href="javascript:;" onclick="ShowMoreF(this);">浏览备注</a>
                             <a href="javascript:;" onclick="opentitle('IDC_Ren.aspx?ID=<%#Eval("Cid") %>','IDC续费');">续费</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
