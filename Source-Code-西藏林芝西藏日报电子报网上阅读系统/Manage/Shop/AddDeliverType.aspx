<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddDeliverType, App_Web_sunz0hm4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
        <tr><td class="td_l">模板名称:</td><td>
            <asp:TextBox runat="server" ID="TlpName_T" CssClass="form-control" MaxLength="100" /></td></tr>
       <%-- <tr><td>是否包邮:</td><td>
     ...
     <%--      <label><input type="radio" value="2" name="pricemod_rad"/>按重量</label></td>--%>
        ...
        <tr><td>备注(买家可见):</td><td><asp:TextBox runat="server" ID="Remind_T" TextMode="MultiLine" CssClass="form-control" /></td></tr>
        <tr><td>备注(仅卖家可见):</td><td><asp:TextBox runat="server" ID="Remind2_T" TextMode="MultiLine" CssClass="form-control"/></td></tr>
