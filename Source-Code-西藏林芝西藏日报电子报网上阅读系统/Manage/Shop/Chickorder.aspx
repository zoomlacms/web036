<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Chickorder, App_Web_sunz0hm4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr>
            <td  align="center" class="style16" rowspan="2">
                ...
                <td align="center" class="title" style="width: 5%;">数量</td>
                 <td width="10%" align="center" class="title">金额</td>
          </tr>
                <tr>      
