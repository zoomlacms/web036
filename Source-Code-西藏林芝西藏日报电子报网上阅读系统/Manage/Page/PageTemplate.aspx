<%@ page language="C#" autoeventwireup="true" inherits="manage.Page.PageTemplate, App_Web_svnn24km" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <tbody id="Tbody1">
                ...
                <tr class="tdbg list0" name="list0" state="1" id="list0">
                    ...
                    <td style="height: 24px" align="left">
                        <a href="javascrip:;"><span class="glyphicon glyphicon-folder-close"></span><span>根栏目</span></a>
                    </td>
