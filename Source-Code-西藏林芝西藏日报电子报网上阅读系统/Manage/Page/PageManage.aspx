<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_PageManage, App_Web_svnn24km" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
    <tbody id="Tbody1">
        ...
        <ZL:ExRepeater ID="Pagetable" runat="server" PageSize="10"  PagePre="<tr id='page_tr'><td class='text-center'><input type='checkbox' id='chkAll'/></td><td colspan='10' id='page_td'>" PageEnd="</td></tr>">
            <ItemTemplate>
                <tr class="tdbg" id="<%#Eval("ID") %>" ondblclick="getinfo(this.id)">  
                    ...
                    <td style="height: 24px" align="center">
                        <a href="/Page/Default.aspx?pageid=<%#Eval("ID") %>" target="_blank">前台预览</a>
                        <%#GetRecommendation()%>
                        <%#GetStatus()%>
