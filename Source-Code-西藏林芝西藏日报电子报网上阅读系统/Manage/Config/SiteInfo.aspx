<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteInfo, App_Web_u0dbdjbl" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableviewstate="False" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        <tr >
            ...
            <td><asp:TextBox ID="TextBox1" runat="server"  class=" form-control text_md"></asp:TextBox></td>
        </tr>
        <tr >
            <td class="tdbgleft"><strong><%:lang.LF("网站标题") %>：</strong></td>
            <td><asp:TextBox ID="TextBox2" runat="server"  class="form-control text_md"></asp:TextBox></td>
        </tr>
        <tr >
          <td class="tdbgleft"><strong><%:lang.LF("网站地址") %>：</strong></td>
          <td><asp:TextBox ID="TextBox3" runat="server"  class="form-control text_md" ></asp:TextBox>
          ...
          <td><asp:TextBox ID="CustomPath" runat="server"  MaxLength="10" class="form-control text_md" onkeyup="value=value.replace(/[^\w\/]/ig,'')"  />
        ...
        <tr >
            ...
            <td><asp:TextBox ID="TextBox4" runat="server"  class="form-control text_md"></asp:TextBox></td>
        </tr>
        <tr >
            <td class="tdbgleft"><strong><%:lang.LF("后台LOGO") %>：</strong></td>
            <td><asp:TextBox ID="TextBox11" runat="server"  class="form-control text_md"></asp:TextBox></td>
        </tr>
        <tr class="tdbg">
            <td class="tdbgleft" style="width: 200px; height: 23px;"><strong><%:lang.LF("Banner地址") %>：</strong></td>
            <td><asp:TextBox ID="TextBox5" runat="server"  class="form-control text_md"></asp:TextBox></td>
        </tr>
        <tr>
          <td style="width: 200px;"><strong><%:lang.LF("公司名称") %>：</strong></td>
          <td>
          <asp:TextBox ID="ComName_T"  runat="server" CssClass="form-control text_md"></asp:TextBox>
           </td>
          </tr>
        <tr >
            <td class="tdbgleft"><strong><%:lang.LF("站长姓名") %>：</strong></td>
            <td><asp:TextBox ID="TextBox6" runat="server" class="form-control text_md"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="tdbgleft"><strong><%:lang.LF("站长手机") %>：</strong></td>
            <td><asp:TextBox ID="MasterPhone_T" runat="server" class="form-control text_md" />
        ...
        <tr >
            ...
            <td><asp:TextBox ID="TextBox7" runat="server" class="form-control text_md" />
