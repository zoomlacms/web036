<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteOption, App_Web_av0ocqlg" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-pane active" id="Tabs0">
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <td style="width:200px"><strong>内容标题重复</strong></td>
                        <td>
...
<%--                    <tr>
        ...
        <div class="tab-pane" id="Tabs3">
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <td style="width: 200px;"><strong><%:lang.LF("IIS可支持最大文件上传") %>：</strong></td>
                        <td>
                            <asp:TextBox ID="txtUploadFileMaxSize" Text="30" Width="200" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            &nbsp;<span>M提示：默认为30M，您可以填写允许的最大值4096M（4G），为0代表继续系统设置(或读系统值)</span>
                       </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtUpMediaSize" Width="200" runat="server" CssClass="form-control"></asp:TextBox>
                            &nbsp;<span>KB
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtUpFlashSize" Width="200" runat="server" CssClass="form-control"></asp:TextBox>
                            &nbsp;<span>KB
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtUpPicSize" runat="server" Width="300" CssClass="form-control"></asp:TextBox>
                            &nbsp;<span>KB
                      提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> </td>
                    </tr>
                    <tr>
        ...
        <div class="tab-pane" id="Tabs4">
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    <tr>
                        <td style="width:200px;"><strong>支付方式</strong></td>
                        <td>
                    ...
                    <tr runat="server" id="OrderMsg_Tr">
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="OrderMsg_ordered_T" TextMode="MultiLine" CssClass="form-control textbox_mid" Height="120" placeholder="下单后后内容模板" />
                            <asp:TextBox runat="server" ID="OrderMsg_payed_T" TextMode="MultiLine" CssClass="form-control textbox_mid" Height="120" placeholder="付款后内容模板" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr runat="server" id="Tr6">
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="OrderMasterMsg_ordered_Tlp" TextMode="MultiLine" CssClass="form-control textbox_mid" Height="120" placeholder="下单后后内容模板" />
                            <asp:TextBox runat="server" ID="OrderMasterMsg_payed_Tlp" TextMode="MultiLine" CssClass="form-control textbox_mid" Height="120" placeholder="付款后内容模板" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr runat="server" id="Tr7">
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="OrderMasterEmail_ordered_Tlp" TextMode="MultiLine" CssClass="form-control textbox_mid" Height="120" placeholder="下单后后内容模板" />
                            <asp:TextBox runat="server" ID="OrderMasterEmail_payed_Tlp" TextMode="MultiLine" CssClass="form-control textbox_mid" Height="120" placeholder="付款后内容模板" />
                        </td>
                    </tr>
                </tbody>
            </table>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        //        $("input[name=" + name + "][value='" + valArr[i] + "']")[0].checked = true;
        //    }
        //}
    </script>
</asp:Content>
