<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_AppConfig, App_Web_u0dbdjbl" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" clientidmode="AutoID" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
            ...
            <td>
                <ul>
                    <asp:Repeater runat="server" ID="ErrRPT">
                        <ItemTemplate>
                            <li><div class="input-group margin_b2px">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox1" runat="server" class="form-control" /></td>
        </tr>
  </table>
