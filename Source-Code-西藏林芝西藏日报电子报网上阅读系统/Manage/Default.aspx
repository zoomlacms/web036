<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_3udahfoi" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<ul class="menu2">
	...
	<li class="menu2_2"><a onclick="ShowMain('SpecialTree.ascx','Content/SpecialManage.aspx')"><%:lang.LF("按专题管理") %></a></li>
...
<ul class="menu5">
	...
	<li class="menu5_3"><a onclick="showleft('menu5_3','Exam/SchConfig.aspx')">排课管理</a></li>
		...
		<ul class="list-unstyled modal_ul">
			...
			<li>
				...
				<ul style="position: relative; display: none;">
					...
					<li><a data-dismiss="modal" onclick="showleft('menu5_3','Exam/ClassManage.aspx')" href="javascript:;"><%:lang.LF("数据管理") %></a></li>
...
<div id="left_ul_div">
	<div id="menu1" class="unstyled m_left_ul open">
        ...
        <div class="toCloud">
        <a href="javascript:;" id="cloud_pic" onclick="ShowMain('','{$path}Template/TemplateSetOfficial.aspx')" title="云端模板免费下载"><img src="/App_Themes/ICMS/images/cloud.png" class="center-block img-responsive" alt="云端模板免费下载" /></a>         
	...
	<div id="menu5" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu5_3">
		     <li class="menu_tit"><span class="glyphicon glyphicon-globe"></span>数据管理</li>
            <li id="menu5_3_6"><a href="javascript:;" data-url="Exam/SchConfig.aspx">基本配置</a></li>
            ...
            <li id="menu5_3_7"><a href="javascript:;" data-url="Exam/AutoPK.aspx">自动排课</a></li>
		</ul>
	...
	<div id="menu6" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu6_2">
            ...
            <li id="menu6_2_3"><a href="javascript:;" data-url="User/SetAdminKey.aspx">管理员口令</a></li>
            <li>
	...
	<div id="menu8" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu8_8">
			...
			<li id="menu8_8_5"><a href="javascript:;" data-url="Pay/Paypalmanage.aspx"><%:lang.LF("Paypal国际支付") %></a></li>
		</ul>
	</div>
...
<script type="text/javascript" src="/JS/ICMS/Main.js?ver=20150318"></script>
